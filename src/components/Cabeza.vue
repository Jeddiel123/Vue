...
<template>
  <Item>
      ...
      <div class="mb-100" id="header">
        ...
        <div id="subtle" class="ml-5 md:ml-10" style="opacity: 1; transform: translate(0px, 0px);">
          ...
          <p class="text-xl md:text-4xl flex items-baseline gap-2">
            <img src="https://cdn-icons-png.flaticon.com/128/732/732200.png" alt="email" class="w-6 h-6">
    ...
    <h1 class="text-black font-family:Monaco text-xl"></h1>
    <br>
    <p class="text-black text-m">
    <a class="text-amber-100" href="#"></a> 
    <p></p>
    </p>
   </div>
